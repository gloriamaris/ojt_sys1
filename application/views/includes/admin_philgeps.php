<div class="large-12" id="box">
      <ul class="side-nav">
		<label><h4>FAQs about PhilGEPS</h4></label>
        ...
        <label><li><a href="#">Who should register with the PhilGEPS?</a></li></label>
		<small>All government agencies including Local Government Units. Suppliers that do business with government.</small>
        <label><li><a href="#">Are all government agencies required to use the PhilGEPS?</a></li></label>
		...
		<label><li><a href="#">When shall government agencies use the PhilGEPS?</a></li></label>
		...
		<label><li><a href="#">Do we have to post all of our agency&rsquo;s procurement needs irrespective of amount?</a></li></label>
		...
		<label><li><a href="#">Our organization (agency/ company) has no internet connection. Does this mean we are exempted from using the PhilGEPS?</a></li></label>
